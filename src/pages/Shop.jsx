...
<meta name="Distribution" content="Global" />
      ...
      <section id="portfolio" className="portfolio">
        <div className="container">
          <header className="section-header" style={{ marginTop: 100 }}>
            <h2>Shop</h2>
            <p>Latest Website Templates</p>
          </header>
              ...
              <div className="portfolio-wrap">
                ...
                <div className="portfolio-info">
                  ...
                  <div className="portfolio-links">
                    <Link to="assets/shop/school5.png" title="School 5">
                      Image
                    </Link>
                    <Link
                      to="assets/shop/school5/index.html"
                      target="_blank"
                      title="More Details"
                    >
                      View
            ...
            <div className="portfolio-item">
              <div className="portfolio-wrap">
                ...
                <div className="portfolio-info">
                  <h4>Website 2</h4>
                  <div className="portfolio-links">
                    <Link to="assets/shop/school5.png" title="School 5" alt="School - Info Era">
                      Image
                    </Link>
                    <Link
                      to="assets/shop/school5/index.html" aria-label="School Management System - Info Era Software Services Pvt. Ltd."
                      target="_blank"
                      title="More Details"
                    >
                      View
            ...
            <div className="portfolio-item">
              <div className="portfolio-wrap">
                ...
                <div className="portfolio-info">
                  <h4>Website 4</h4>
                  <div className="portfolio-links">
                    <Link to="assets/shop/school5.png" aria-label="School - Info Era Software Services Pvt. Ltd." alt="School-Info Era" title="School 5">
                      Image
                    </Link>
                    <Link
                      to="assets/shop/school5/index.html" aria-label="Canonical - Info Era Software Services Pvt. Ltd."
                      target="_blank"
                      title="More Details"
                    >
                      View
              ...
              <div className="portfolio-wrap">
                ...
                <div className="portfolio-info">
                  ...
                  <div className="portfolio-links">
                    ...
                    <Link
                      to="assets/shop/school5/index.html" aria-label="School - Info Era Software Services Pvt. Ltd."
                      target="_blank"
                      title="More Details"
                    >
                      View
            ...
            <div className="portfolio-item">
              <div className="portfolio-wrap">
                ...
                <div className="portfolio-info">
                  <h4>Website 6</h4>
                  <div className="portfolio-links">
                    <Link to="assets/shop/school5.png" aria-label="School - Info Era Software Services Pvt. Ltd." title="School 5">
                      Image
                    </Link>
                    <Link
                      to="assets/shop/school5/index.html" aria-label="School - Info Era Software Services Pvt. Ltd."
            ...
            <div className="portfolio-item">
              <div className="portfolio-wrap">
                ...
                <div className="portfolio-info">
                  <h4>Website 8</h4>
                  <div className="portfolio-links">
                    <Link to="assets/shop/school5.png" alt="School-Info Era" title="School 5">
                      Image
                    </Link>
                    <Link
                      to="assets/shop/school5/index.html"
