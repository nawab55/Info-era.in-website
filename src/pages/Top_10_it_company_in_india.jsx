...
function Top_10_it_company_in_india() {
  return (
    <>
      <Helmet>
        <meta charset="utf-8" />
        ...
        {/* End */} 
        <title>
          Top 10 IT Company in India | Best Software Company in India
        </title>
        <meta
          name="description"
          content="Discover India's leading IT giants! Info Era Software Services Pvt. Ltd. is among the top 10 IT companies in India, offering premier software and website development, including e-commerce solutions."
        />
        ...
        />
        <link rel="canonical" href="https://infoera.in/top_10_it_company_in_india"  aria-label="Canonical - Info Era Software Services Pvt. Ltd."/>
      ...
      <section id="hero" className="hero d-flex align-items-center">
        <div className="container">
          <div className="col-lg-12 d-flex flex-column justify-content-center ">
            ...
            >
              The IT industry in India is burgeoning, with several companies
              making significant strides in the sector. Among the leading names,
              three companies stand out: Info Era Software Services Pvt. Ltd,
              Accenture, and Wipro . Each of these companies brings unique
              strengths and capabilities to the table, contributing to the
              state&apos;s growing reputation as an IT hub.
            </p>
            <br />
            <p
            ...
            >
              ...
              maintained. Among the IT firms in your vicinity, Info Era Software
              Services Pvt. Ltd. stands out for providing a broad range of
              services, including network administration and cybersecurity. Our
              team of professionals is always available to offer tailored
              assistance to maintain the smooth running of your company.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="features">
        <div className="container aos-init aos-animate" data-aos="fade-up">
          <header className="section-header">
            <h2>Overview</h2>
            <p>Top IT Companies in India: A Comparative Overview</p>
          </header>
          <div className="row">
            <div className="col-lg-12 mt-5 mt-lg-0 d-flex">
              <div className="row align-self-center gy-4">
                ...
                >
                  <div className="feature-box d-flex align-items-center">
                    ...
                    <div className="col-lg-10">
                      ...
                      <p>
                        As the top IT company in Kishanganj, Info Era Software
                ...
                >
                  <h3>
                    Mobile based fully responsive websites and applications
                  </h3>
                  <div className="row">
                    <div
                      ...
                      <div className="row align-self-center gy-4">
                        ...
                        >
                          ...
                          <div>
                            <h4>Compatibility</h4>
                            <p>
                              Mobile Applications and Websites are compatible
                              across devices.
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p style={{ textAlign: "justify" }}>
                              For mobile devices Websites and Applications can
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p>
                              Push notifications to users who have the app
                        ...
                        >
                          ...
                          <div>
                            <h4>Immediacy</h4>
                            <p style={{ textAlign: "justify" }}>
                              A mobile website is instantly accessible to users
                              via a browser across a range of devices (iPhone,
                              Android, etc).
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p>
                              Features that make a Social website and Media
                              Mobile App popular.
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p style={{ textAlign: "justify" }}>
                              ...
                              because their pages can be displayed in search
                              results.
                            </p>
                          </div>
                        </div>
...
export default Top_10_it_company_in_india;
