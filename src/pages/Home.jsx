...
const Home = () => {
  return (
    ...
    <link href="assets/img/favicon.png" rel="icon" alt="Favicon" title="Favicon"  aria-label="Favicon - Info Era Software Services Pvt. Ltd." />
    ...
    <meta
        ...
        <meta
          name="keywords"
          content="software development company in patna, best it company in patna, it company in patna for internship, 
        ...
        <meta name="abstract" content="Software Development company in Patna, Website Development Company in Patna, Customer Budget Website Design Company Patna, Experienced Web Designing Company Patna,
       ...
       Web Captioning Software Patna(Patna), Website Security Division Patna, Animated Web Graphics Patna, Bihar, GST Billing Software, Internship, E-Commerce Development, IT Company, Bulk SMS and Voice Call, Graphic Designing, Web Hosting, SEO services provider in Patna Bihar India" />
        ...
        <meta name="keyphrases" content="Software development in Patna, Web Design and Development Company in Patna, SEO, Bulk SMS, Customized GST Billing Software developer in Patna,
