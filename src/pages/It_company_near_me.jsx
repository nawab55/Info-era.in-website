  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Looking for IT companies around you? Info Era Software Services Pvt. Ltd. offers local expertise and top-notch IT solutions."
        />
        <meta
          name="keywords"
        ...
        <div className="container ">
          <div className="row">
            ...
            <div className="col-lg-12 d-flex flex-column justify-content-center ">
              ...
              >
                Businesses rely significantly on IT infrastructure to run
                effectively in the current digital era. Locating a trustworthy
                local managed IT services provider can have a big impact on the
                security and efficiency of your company. As the leading provider
                of managed IT services in the region, we at Info Era Software
                Services Pvt. Ltd. take great pleasure in providing
                comprehensive solutions that are specifically designed to
                satisfy the needs of companies of all sizes.
              </p>
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                <h3 data-aos="fade-up" className="aos-init aos-animate">
                  Top IT Companies Around You
                </h3>
              </div>
              <p
                style={{ textAlign: "justify", margin: 0 }}
                ...
                className="aos-init aos-animate"
              >
                It might be difficult to find the best local IT business, but
                doing so is essential to keeping your IT infrastructure
                maintained. Among the IT firms in your vicinity, Info Era
                Software Services Pvt. Ltd. stands out for providing a broad
                range of services, including network administration and
                cybersecurity. Our team of professionals is always available to
                offer tailored assistance to maintain the smooth running of your
                company.
              </p>
            </div>
            ...
            <div className="col-lg-12 mt-5 mt-lg-0 d-flex">
              <div className="row align-self-center gy-4">
                ...
                <p>
                  ...
                  top web development company. We build responsive, high-quality
                ...
                <p>
                  The reason we are the greatest IT firm in Mirzapur is because
                  ...
                  solutions that promote corporate success and expansion thanks
                  to our thorough approach.
                </p>
                <header className="section-header">
...
export default It_company_near_me;
