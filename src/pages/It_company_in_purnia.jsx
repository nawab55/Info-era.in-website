  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Info Era Software Services Pvt. Ltd. - the top IT company in Purnia offering comprehensive software development, web design, and web development services tailored to your business needs."
        />
        <meta
          name="keywords"
            ...
            <div className="row">
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                <h1 data-aos="fade-up" className="aos-init aos-animate">
                  Leading IT Company in Purnia - Info Era Software Services Pvt.
                  Ltd.
                </h1>
              </div>
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                ...
                >
                  Purnia, a city renowned for its dynamic past and rich cultural
                  legacy, is quickly becoming a center for innovation and
                  technology. Info Era Software Services Pvt. Ltd., the top IT
                  firm in Purnia, is leading the charge in this change. We
                ...
                <div className="col-lg-12 d-flex flex-column justify-content-center ">
                  <h3 data-aos="fade-up" className="aos-init aos-animate">
                    Top Software Development Company in Purnia
                  </h3>
                </div>
                <p
                  style={{ textAlign: "justify", margin: 0 }}
                  ...
                  className="aos-init aos-animate"
                >
                  We are a leading Purnia software development company that
                  specializes in developing unique software solutions that
                  improve operations and spur company expansion. We guarantee
                  the delivery of reliable, scalable, and effective software
                  solutions thanks to the expertise of our team of skilled
                  developers in the newest technologies and processes. Info Era
                  Software Services Pvt. Ltd. may provide you with custom
                  software solutions, mobile apps, or business applications.
                </p>
              </div>
            </div>
          </div>
...
export default It_company_in_purnia;
