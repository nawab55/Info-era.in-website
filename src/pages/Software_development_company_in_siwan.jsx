          ...
          <div className="row">
            <div className="col-lg-12 d-flex flex-column justify-content-center ">
              <h1 data-aos="fade-up" className="aos-init aos-animate">
                Leading Software Development Company in Siwan, Bihar
              </h1>
            </div>
            <div className="col-lg-12 d-flex flex-column justify-content-center ">
              <p
              ...
              >
                In the swiftly changing digital terrain, companies in Siwan,
...
export default Software_development_company_in_siwan;
