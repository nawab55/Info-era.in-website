          ...
          <div className="row">
            <div className="col-lg-12 d-flex flex-column justify-content-center ">
              <h1 data-aos="fade-up" className="aos-init aos-animate">
                Leading Software Development Company in Muzaffarpur, Bihar
              </h1>
            </div>
            <div className="col-lg-12 d-flex flex-column justify-content-center ">
              <p
              ...
              >
                In the swiftly changing digital terrain, companies in
                Muzaffarpur, Bihar are realizing the value of reliable software
                and online solutions. Our mission at Info Era Software Services
                Pvt. Ltd. is to support businesses in thriving in the digital
                era by offering superior web design and software development
                services. This is why we should be your first pick for any and
                all IT needs in Muzaffarpur.
              </p>
            </div>
              ...
              <div className="row align-self-center gy-4">
                ...
                >
                  <div className="article-content">
                    ...
                    <h4>2. Top Website Development Company in Muzaffarpur</h4>
                    <p>
                    ...
                    <h4>
                      3. Best Software Training Company in Muzaffarpur, Bihar
                    </h4>
                    <p>
                    ...
                    <h4>5. Leading IT Company in Muzaffarpur, Bihar</h4>
                    <p>
...
export default Software_development_company_in_muzaffarpur;
