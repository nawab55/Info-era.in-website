  ...
  return (
    <>
      <Helmet>
        ...
        />
         <link rel="canonical" href="https://infoera.in/it_company_mirzapur" />
              ...
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                ...
                <div className="col-lg-12 d-flex flex-column justify-content-center ">
                  <h3 data-aos="fade-up" className="aos-init aos-animate">
                    Best Website Design and Development Company in Mirzapur
                  </h3>
                </div>
                <p
                  style={{ textAlign: "justify", margin: 0 }}
                ...
                >
                  ...
                  user-friendly websites is our mission as the top Mirzapur
            ...
            <div className="row">
              <div className="col-lg-12 mt-5 mt-lg-0 d-flex">
                <div className="row align-self-center gy-4">
                  ...
                  <p>
                    The reason we are the greatest IT firm in Mirzapur is
...
export default It_company_mirzapur;
