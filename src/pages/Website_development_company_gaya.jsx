            ...
            <div className="row">
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                <h1 data-aos="fade-up" className="aos-init aos-animate">
                  The Premier Website Development Company in Gaya, Bihar
                </h1>
              </div>
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                <p
                ...
                >
                  ...
                  in website development and IT training in Gaya, Bihar, one
...
export default Website_development_company_gaya;
