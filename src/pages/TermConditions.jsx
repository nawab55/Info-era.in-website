    ...
    <p>Welcome to Info Era Software Services Pvt. Ltd.</p>
              ...
              >
                <div className="col-lg-12">
                  <h3 style={{}}>Our Terms &amp; Condition</h3>
                  <hr />
                  <h3>1. Introduction</h3>
                  <p>
                    Welcome to INFO ERA SOFTWARE SERVICES PVT. LTD. (“Company”,
                    “we”, “our”, “us”)! These Terms of Service (“Terms”, “Terms
                    of Service”) govern your use of our website located at
                    www.infoerasoftwareservices.com and web application as “Info
                    Era Software Services” (together or individually “Service”)
                    operated by us.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    emailing at info@infoerasoftware.com we can try to find a
                  ...
                  <p>
                    ...
                    link or by emailing at info@infoerasoftware.com.
                  </p>
                  <h3>3. Purchases</h3>
                  <p>
                  ...
                  <p>
                    ...
                    (&quot;Subscription(s)&quot;). You will be billed in advance
                    on a recurring and periodic basis (&quot;Billing
                    Cycle&quot;). Billing cycles will be set depending on the
                  ...
                  <p>
                    ...
                    management page or by contacting info@obomart.comcustomer
                    support team.
                  </p>
                  <p>
                    A valid payment method is required to process the payment
                    for your subscription. You shall provide us with accurate
                    and complete billing information that may include but not
                    ...
                    authorize us to charge all Subscription fees incurred
                    through your account to any such payment instruments.
                  </p>
                  <p>
                    Should automatic billing fail to occur for any reason, we
                    reserve the right to terminate your access to the Service
                    with immediate effect.
                  </p>
                  <h3>6. Free Trial</h3>
                  <p>
                    We may, at its sole discretion, offer a Subscription with a
                  ...
                  <p>
                    ...
                    Free Trial, you will not be charged by we until Free Trial
                    has expired. On the last day of Free Trial period, unless
                  ...
                  <p>
                    ...
                    modify Terms of Service of Free Trial offer, or (ii) cancel
                    such Free Trial offer.
                  </p>
                  <h3>7. Fee Changes</h3>
                  <p>
                    We, in its sole discretion and at any time, may modify
                  ...
                  <p>
                    ...
                    us or used with permission. You may not distribute, modify,
                  ...
                  <p>
                    9.1. In any way that violates any applicable national or
                    international law or regulation.
                  </p>
                  <p>
                    9.2. For the purpose of exploiting, harming, or attempting
                    to exploit or harm minors in any way by exposing them to
                    inappropriate content or otherwise.
                  </p>
                  <p>
                    9.3. To transmit, or procure the sending of, any advertising
                    or promotional material, including any “junk mail”, “chain
                    letter,” “spam,” or any other similar solicitation.
                  </p>
                  <p>
                    9.4. To impersonate or attempt to impersonate Company, a
                    Company employee, another user, or any other person or
                    entity.
                  </p>
                  <p>
                    9.5. In any way that infringes upon the rights of others, or
                    in any way is illegal, threatening, fraudulent, or harmful,
                    or in connection with any unlawful, illegal, fraudulent, or
                    harmful purpose or activity.
                  </p>
                  <p>
                    9.6. To engage in any other conduct that restricts or
                  ...
                  <h3>10. Additionally, you agree not to:</h3>
                  <p>
                  ...
                  <p>
                    ...
                    the exclusive property of we and its licensors. Service is
                  ...
                  <p>
                    ...
                    infoerapvtltd@gmail.com with the subject line: “Copyright
                    Infringement” and include in your claim a detailed
                    description of the alleged Infringement as detailed below,
                    under “Local (Indian constituency and official region)
                    copyright act Notice and Procedure for Copyright
                    Infringement Claims” You may be held accountable for damages
                    (including costs and attorneys’ fees) for misrepresentation
                    or bad-faith claims on the infringement of any Content found
                    on and/or through Service on your copyright.
                  </p>
                  <h3>
                    16. COPYRIGHT Notice and Procedure for Copyright
                    Infringement Claims
                  </h3>
                  <p>
                    You may submit a notification pursuant to the Local (Indian
                    constituency and official region) Copyright Act by providing
                    our Copyright Agent with the required information.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    infoerapvtltd@gmail.com via third party sites and tools with
                  ...
                  <p>
                    ...
                    materials included therein. You expressly agree that you’re
                  ...
                  <p>
                    ...
                    with the laws of Indian provinces, which governing law
                  ...
                  <p>
                    ...
                    technical support by email: infoerapvtltd@gmail.com
                  </p>
                </div>
                {/* <div class="col-lg-6">
