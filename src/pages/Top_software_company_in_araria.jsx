...
function Top_software_company_in_araria() {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        ...
        />
         ...
         <link rel="canonical" href="https://infoera.in/top_software_company_in_araria" aria-label="Canonical - Info Era Software Services Pvt. Ltd."/>
      ...
      <div className="container">
        <div className="col-lg-12 d-flex flex-column justify-content-center ">
          <h1 data-aos="fade-up" className="aos-init aos-animate">
            Top Software Company in Araria: Elevating Digital Excellence
          </h1>
          <p
          ...
          >
            The demand for digital solutions is rising significantly in Araria,
            a bustling district in Bihar. To remain competitive in the digital
            era, local businesses are looking more and more for web development
            and high-quality software services. Here is a list of the top
            businesses in Araria offering these services.
          </p>
          <p
            style={{ textAlign: "justify", marginTop: 35 }}
            data-aos="fade-up"
            ...
            className="aos-init aos-animate"
          >
            With a reputation for providing innovative and customized software
            solutions, Info Era Software Services Pvt. Ltd. is the top software
            company in Araria. Their specialty is developing software that is
            both dependable and scalable, while also accommodating the
            particular needs of many industries. CRM software and enterprise
            resource planning (ERP) solutions are only two examples of their
            products that boost productivity and operational efficiency.
          </p>
        </div>
      </div>
    </section>
              ...
              >
                <div className="feature-box d-flex align-items-center">
                  ...
                  <div className="col-lg-10">
                    ...
                    <p>
                      <a href="http://www.infoeraservices.com" aria-label="Info Era - Info Era Software Services Pvt. Ltd.">
              ...
              >
                <div className="feature-box d-flex align-items-center">
                  ...
                  <div className="col-lg-10">
                    ...
                    <p>
                      Email:{" "}
                      <a href="mailto:contact@infosys.com" aria-label="Infosys - Info Era Software Services Pvt. Ltd.">
                        contact@infosys.com
                      </a>
                    </p>
                  </div>
              ...
              >
                <div className="feature-box d-flex align-items-center">
                  ...
                  <div className="col-lg-10">
                    ...
                    <p>
                      Email:{" "}
                      <a href="mailto:investors@hcl.com" aria-label="HCL - Info Era Software Services Pvt. Ltd.">investors@hcl.com</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="feature-box d-flex align-items-center">
                  ...
                  <div className="col-lg-10">
                    ...
                    <p>
                      Email:{" "}
                      <a href="mailto:info@techasoft.com" aria-label="Techasoft Email- Info Era Software Services Pvt. Ltd.">info@techasoft.com</a>
                    </p>
                  </div>
                </div>
              </div>
...
export default Top_software_company_in_araria;
