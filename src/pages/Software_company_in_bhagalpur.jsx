            ...
            <div className="row">
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                <h1 data-aos="fade-up" className="aos-init aos-animate">
                  Leading Software Company in Bhagalpur
                </h1>
              </div>
              <div className="col-lg-12 d-flex flex-column justify-content-center ">
                <p
                ...
                >
                  The northern Bihar district of East Champaran is quickly
                  emerging as a major center for digital transformation and
                  technology innovation. Info Era Software Services Pvt. Ltd. is
                  one of the leading companies offering web design and software
                  development services amidst the increasing number of tech
                  companies. Businesses in East Champaran come to us because of
                  our all-inclusive solutions and commitment to excellence.
                </p>
                <br />
                <p
                  style={{ textAlign: "justify", margin: 0 }}
                  ...
                  className="aos-init aos-animate"
                >
                  In our approach to web development, design and functionality
                  go hand in hand. Being Bhagalpur&apos;s top website design and
                  development firm, we concentrate on creating aesthetically
                  pleasing and incredibly useful websites. Because of the
                  user-centric nature of our designs, visitors are guaranteed a
                  smooth user experience that boosts conversions and keeps them
                  interested.
                </p>
              </div>
            ...
            <div className="row">
              <div className="col-lg-12 mt-5 mt-lg-0 d-flex">
                <div className="row align-self-center gy-4">
                  <h4>Top Web Development Company in Bhagalpur</h4>
                  <p>
                    Businesses nowadays must have a strong online presence, and
                    Info Era Software Services Pvt. Ltd. shines as Bhagalpur&apos;s
                  ...
                  <h4>Best IT Company in Bhagalpur</h4>
                  <p>
                    The reason we are the greatest IT firm in Bhagalpur is
                  ...
                  <header className="section-header">
                    <p>IT Training Center in Bhagalpur</p>
                  </header>
                  <h4> Comprehensive Training Programs</h4>
                  <p>
                    Info Era Software Services Pvt. Ltd. offers web development
                    services, but we&apos;re also one of Bhagalpur&apos;s top providers of
...
export default Software_company_in_bhagalpur;
